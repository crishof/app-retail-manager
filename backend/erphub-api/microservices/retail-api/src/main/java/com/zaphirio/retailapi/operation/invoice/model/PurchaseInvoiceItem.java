 ...
 */
@Entity
@Table(name = "tbl_purchase_invoice_items")
@Data
@NoArgsConstructor
@AllArgsConstructor
@Builder
public class PurchaseInvoiceItem {
    ...
    /**
     * Parent purchase invoice (N:1 relationship).
     */
    ...
    /**
     * Product ID (optional, can be NULL if item not yet matched to catalog).
     */
    @Column(name = "product_id")
    private UUID productId;

    /**
     * Item description (from supplier).
     */
    ...
    /**
     * Unit price (supplier's price, before tax).
     */
    @Column(name = "unit_price", nullable = false)
    private double unitPrice;

    /**
     * Line discount percentage (from supplier, if any).
     */
    ...
    /**
     * Audit: timestamp when item was created/received.
     */
     ...
     */
    public double getUnitCostWithTax() {
        return getLineTotalWithTax() / quantity;
    }
}
