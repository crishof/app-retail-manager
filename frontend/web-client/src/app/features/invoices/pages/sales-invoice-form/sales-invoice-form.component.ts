...
import { SalesInvoiceService, CreateSalesInvoiceRequest, SalesInvoiceItem } from '../../../../core/services/sales-invoice.service';
        ...
        <div class="max-w-5xl mx-auto px-6 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h1 class="text-3xl font-bold text-slate-900">New Sales Invoice</h1>
                <p class="text-slate-500 mt-1">Create a new customer invoice</p>
              </div>
            </div>
            <button
              (click)="submitForm()"
...
export class SalesInvoiceFormComponent implements OnInit {
  ...
  calculateLineTotal(item: SalesInvoiceItem): number {
