...
import { QuoteService, CreateQuoteRequest, QuoteItem } from '../../../../core/services/quote.service';
        ...
        <div class="max-w-5xl mx-auto px-6 py-6">
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
              ...
              <div>
                <h1 class="text-3xl font-bold text-slate-900">New Quotation</h1>
                <p class="text-slate-500 mt-1">Create a new customer quotation</p>
              </div>
            </div>
            <button
              (click)="submitForm()"
      ...
      <div class="max-w-5xl mx-auto px-6 py-6">
        <form [formGroup]="form">
          ...
          <div class="bg-white rounded-lg border border-slate-200 p-6 mb-6">
            <h2 class="text-xl font-bold text-slate-900 mb-4">Quotation Details</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label class="block text-sm text-slate-600 font-medium mb-1">Customer ID *</label>
                <input
                  type="text"
              ...
              <div>
                <label class="block text-sm text-slate-600 font-medium mb-1">Quotation Number *</label>
                <input
                  type="text"
              ...
              <div>
                <label class="block text-sm text-slate-600 font-medium mb-1">Expiration Date *</label>
                <input
                  type="date"
...
export class QuoteFormComponent implements OnInit {
  ...
  constructor() {
    this.form = this.fb.group({
      ...
      documentType: ['QUOTATION', Validators.required],
  ...
  submitForm() {
    ...
    this.quoteService
      ...
      .subscribe({
        ...
        error: () => console.error('Failed to create quote')
      });
  }
}
